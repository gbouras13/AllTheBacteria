...
Then, only proteins belonging to genomes passing QC (i.e. PASS) from `Aggregated/work_in_progress_2025-05/species_calls.tsv.gz` [here](https://osf.io/h7wzy/files/osfstorage) were filtered to prioritise highly confident genome assemblies and protein calls.
